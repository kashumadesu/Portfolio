    ...
    <>
      ...
      <main className="min-h-screen bg-[#0B090E] text-[#E9D5FF] px-4 py-8 md:px-12 md:py-16 font-sans">
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <header id="home" className="bg-[#15111E] border border-purple-950/60 rounded-3xl p-8 flex flex-col md:flex-row items-center gap-8 justify-between scroll-mt-24">
